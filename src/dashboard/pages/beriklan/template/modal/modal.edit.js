...
export const Modal_edit = ({ show, onHide, get_data1, template_id1 }) => {
  ...
  const get_data = async () => {
    ...
    await api_template
      .get_template_detail({ template_id: template_id1 })
      .then((res) => {
        ...
        if (res?.success) {
          setSelected((state) => ({
            ...
            channel: {
              value: res.data.ms_inventory.ms_inventory_id,
              label: res.data.ms_inventory.ms_inventory_identifier,
            },
          }));
          setInput((state) => ({
            ...state,
            nama_template: res.data.template_name,
            konten_template: res.data.template_content,
          }));
        }
      });

    await api_template.get_media({ template_id: template_id1 }).then((res) => {
  ...
  const btnSimpan = async () => {
    ...
    await api_template
      .put_template({ body: body, template_id: template_id1 })
      .then(async (res) => {
          ...
          <div className="row mb-3 mb-md-3">
            <div className="col-md-6 col-lg-6 col-sm-12">
              <div style={{ display: "block" }}>
                <Label color={COLOR_SECONDARY}>File Media</Label> <br />
